...
#define  CPX_VERSION  1121

/* Also include an SCCS version string */

#if defined(CPXWIN32) || defined(CPXWIN64)
#define CPX_VERSIONSTRING "@(#)ILOG Software: product CPLEX, library cplex112.lib, version 11.2.1, date 11/28/2008, Copyright (C) 1997-2008 by ILOG"
#else
#define CPX_VERSIONSTRING "@(#)ILOG Software: product CPLEX, library libcplex.a, version 11.2.1, date 11/28/2008, Copyright (C) 1997-2008 by ILOG"
#endif
...
int CPXPUBLIC
   CPXfeasoptext (CPXCENVptr env, CPXLPptr lp, int grpcnt, int concnt,
                  double *grppref, const int *grpbeg, const int *grpind,
                  const char *grptype);
...
#define CPX_CUT_LOCALCOVER 10
#define CPX_CUT_TIGHTEN    11
#define CPX_CUT_OBJDISJ    12
#define CPX_CUT_USER       13
#define CPX_CUT_TABLE      14
#define CPX_CUT_SOLNPOOL   15
#define CPX_CUT_NUM_TYPES  16
